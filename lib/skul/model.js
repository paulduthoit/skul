 ...
 * @api public
 */
Model.prototype.getDisplayedKeys = function(params, willReturnNullIfEmpty) {
	if(typeof this.displayedKeys === 'function') return this.displayedKeys(params);
	else if(this.displayedKeys instanceof Array) return this.displayedKeys;
	else if(!willReturnNullIfEmpty) return this.structureColumns;
	else return null;
};
