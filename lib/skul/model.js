...
var Model = function(dbConnection, tableName) {
	...
	// Set displayed keys
	this.displayedKeys = { default: null };
	this.displayedKeysFunc = function() { return null; };
...
Model.prototype.displayedKeys;
Model.prototype.displayedKeysFunc;
...
/*
 * Set displayed keys function && keys
 *
 * @params {Object} keys
 ...
 * @api public
 */
Model.prototype.setDisplayedKeys = function(keys, func) {

	// Check arguments
	if (!(typeof func === "function" && func !== null))
		throw new Error("func have to be an function");
	if (!(typeof keys === "object" && keys !== null) && keys.default)
		throw new Error("keys have to be an object with a default value");

	// Set instance data
	this.displayedKeys = keys;
	this.displayedKeysFunc = func;
 ...
 * @api public
 */
Model.prototype.getDisplayedKeys = function(params) {

	// Show all fields if no params
	if (!params) return null;

	return this.displayedKeysFunc(this.displayedKeys, params);
};
