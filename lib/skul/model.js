...
/*
 * Set displayed keys function
 *
 * @params {Function} func
 *
 * @api public
 */
Model.prototype.setDisplayedKeys = function(keys) {
 ...
 * @api public
 */
Model.prototype.getDisplayedKeys = function(auth) {

	// Show all fields if no auth
	if (!auth) return null;

	return this.displayedKeys[auth.type] || this.displayedKeys.default;
};
