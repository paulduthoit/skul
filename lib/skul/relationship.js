...
module.exports.addRelationship = function(type, key, relationship) {
	...
	// Check arguments
	if(!(typeof type === "string" && _.contains([ 'belongsTo', 'hasMany', 'hasOne', 'hasManyCustom', 'hasOneCustom' ], type)))
		throw new Error("type have to be a string defined as belongsTo, hasMany, hasOne, hasManyCustom or hasOneCustom");
	...
	// If type is hasManyCustom
		...
		if(!(typeof relationship.join === "object" && relationship.join !== null))
			throw new Error("relationship.join have to be an object");
		if(!(typeof relationship.join.type === "string"))
			throw new Error("relationship.join.type have to be a string");
		if(!((typeof relationship.join.table === "object" && relationship.join.table !== null) || relationship.join.table instanceof Array))
			throw new Error("relationship.join.type have to be an object or an array");
...
module.exports.getRelationships = function(type) {
	...
	// Check arguments
	if(!(typeof type === "string" && _.contains([ 'belongsTo', 'hasMany', 'hasOne', 'hasManyCustom', 'hasOneCustom' ], type)) && typeof type !== "undefined")
		throw new Error("type have to be a string defined as belongsTo, hasMany, hasOne, hasManyCustom or hasOneCustom");
