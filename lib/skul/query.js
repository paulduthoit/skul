...
// Parse filter
_parseFilter = function(filter, hashAlias) {
...
// Parse filter item
_parseFilterItem = function(item, hashAlias, alreadyFullfill) {
...
// Parse fields
_parseFields = function(model, fields, hashAlias, alias, queryBuilder) {
