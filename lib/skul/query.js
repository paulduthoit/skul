 ...
 * @params {Number} [aliasStart]
 *
 * @return {Object}
 * @api public
 */
module.exports.createSelectQuery = function(filter, fields, options, hashAlias, aliasStart) {

    // Data
    var self = this;
    var alias = aliasStart ? String(aliasStart) : '1';
    var alias2 = aliasStart ? String(aliasStart + 1) : '2';
	...
	mainQueryBuilder.setFromRaw({ queryBuilder: subQueryBuilder, alias: alias2 });
