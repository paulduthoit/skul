...
QueryBuilder.prototype.setSource = function(source) {
	this.source = source;
};

QueryBuilder.prototype.getSource = function() {
	return this.source;
};
...
QueryBuilder.prototype.addJoin = function(type, args) {
	...
	// Push if not exists
	if(joinItemRef === -1) {
		this.joins.push({ type: type, args: args instanceof Array ? args : [ args ] });
	}
